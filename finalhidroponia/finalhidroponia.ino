...
static word homePage() {
 ...
 bfill.emit_p(PSTR("<!DOCTYPE html>\n"
      ...
      "<meta http-equiv='refresh' target='_blank' content='5;url=http://192.168.1.46:81/webservice/rreporte.php?hum=$L&&temp=$L&&hsuelo=$L'>"
       "<meta charset='utf-8'></head><bodystyle='background-color:red;'>"
      "<center>"
      ...
      "</body></html>"      
      ),hum1,tem1,hu,millis()/1000,Estadollave1,Estadollave2,Estadollave3);
